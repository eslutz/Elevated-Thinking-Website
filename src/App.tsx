...
export default function ElevatedOnePageSite() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F6] text-[#2F2F2F]">
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg text-[#37514E]/90">
            Elevated helps teams make better decisions across product, service, and operational systems using design,
            strategy, and AI where it actually matters.
          </p>
          <button className="mt-8 rounded-xl bg-[#37514E] px-6 py-3 text-white">Start a conversation</button>
        </div>
      ...
      <section id="services" className="mx-auto max-w-7xl space-y-24 px-6 py-16">
        {services.map((service, i) => (
          ...
          >
            <div className="relative">
              <div className="aspect-[4/5] rounded-3xl bg-[#D9DBD9]" />
              <div className="absolute right-[-20px] top-8 w-60 rounded-2xl bg-[#37514E] p-6 text-white shadow-lg">
            ...
            <div>
              ...
              <p className="mt-4 max-w-md text-lg text-[#37514E]/90">{service.body}</p>
            </div>
          </div>
        ))}
      </section>
      ...
      <section id="approach" className="bg-[#37514E] px-6 py-20 text-white">
        <div className="mx-auto max-w-5xl text-center">
          <h2 className="text-4xl font-serif leading-tight">Built for work where decisions actually matter.</h2>
          <p className="mt-6 text-lg text-white/80">
            Government. Defense. Enterprise. Regulated environments. Places where complexity is real and shortcuts do
            not survive contact.
          </p>
        </div>
      </section>
        ...
        <div className="relative rounded-3xl bg-[#B7CBCD] p-12">
          <div className="max-w-xl">
            <h3 className="text-3xl font-serif leading-tight">
              Bring us in when the problem spans teams, systems, or consequences.
            </h3>
            <p className="mt-4 text-[#37514E]/90">
              Especially early, before decisions calcify into expensive problems.
            </p>
          </div>

          <div className="absolute bottom-[-20px] right-10 rounded-xl bg-[#C14A11] px-6 py-4 text-white shadow-lg">
      ...
      <footer id="contact" className="border-t border-black/5 px-6 py-10">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 lg:flex-row">
          <div>
            ...
            <p className="mt-2 text-sm text-[#37514E]/80">Design-led strategy and AI-enabled product work.</p>
          </div>
          <div className="text-sm">
            <div>lindsey@elevatedthinking.co</div>
            <div>paul@elevatedthinking.co</div>
          </div>
        </div>
      </footer>
    </div>
