    ...
    <div id="top" className="min-h-screen bg-[#F8F8F6] text-[#2F2F2F]">
      <header className="sticky top-0 z-40 border-b border-black/5 bg-[#F8F8F6]/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <a href="#top" className="flex items-center gap-3 text-inherit">
            <div
              aria-hidden="true"
              className="h-9 w-9 rounded-xl bg-[#37514E]"
            />
            <span className="text-xl font-semibold">Elevated</span>
          </a>
          <nav
            aria-label="Primary"
            className="hidden gap-8 text-sm text-[#37514E] md:flex"
          >
      ...
      <main>
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2">
          <div>
            ...
            <a
              href="#contact"
              className="mt-8 inline-flex rounded-xl bg-[#37514E] px-6 py-3 text-white"
            >
          ...
          <div className="relative">
            <div
              aria-hidden="true"
              className="aspect-4/5 rounded-3xl bg-[#D9DBD9]"
            />
        ...
        <section className="mx-auto max-w-7xl px-6 py-20">
          <div className="relative rounded-3xl bg-[#B7CBCD] p-12">
            ...
            <a
              href="#contact"
              className="absolute -bottom-5 right-10 rounded-xl bg-[#8F340B] px-6 py-4 text-white shadow-lg"
            >
              Start a conversation
            </a>
          </div>
